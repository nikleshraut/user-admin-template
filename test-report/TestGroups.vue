        ...
        <div >
          ...
          <div class="table-responsive"  v-if="showPage">
            ...
            <div class="col-sm-12 form-group">
              <button v-on:click="addRecord" class="row btn btn-primary btn-sm pull-right">Add new test group</button>
            </div>
            <table id="data_tbl" class="table table-striped b-t b-b list-table">
              <thead>
                <tr>
                  <th width="35%" class="table-th">Group</th>
                  <th width="30%" class="table-th">Test</th>
              ...
              <tbody>
                <tr v-for="(record,index) in records">
                  ...
                  <td class="table-td">{{record.test_name}}</td>
                  <td class="table-td">
...
<script>
  ...
  export default {
    mounted() {
      ...
      /*this.$parent.page_title = "All Test Group";
      this.getRecords();
      this.getTests();*/
    ...
    data: function() {
      return {
        ...
        status_confirmation:'',
        test_groups: this.$parent.test_groups,
        tests:{},
        showPage:false,
        valid_access:false,        
      }
    ...
    methods: {
      ...
      getRecords: function(){
        ...
        this.$http.get('/test-groups').then((response) => {
          ...
          this.$parent.test_groups = this.records;
          setTimeout(function() {
            $("#data_tbl").dataTable();
          }, 100);
        }, (response) => {
      ...
      updateRecord: function(record_id){
        location.href = '#/test-group/'+record_id;
      },
      ...
      deleteRecord: function(){
        ...
        this.$http.delete('/test-groups/'+record_id).then((response) => {
          this.showloader = false;
      ...
      changeStatus: function(){
        ...
        this.$http.post('/api/test_group_status',input).then((response) => {
          this.showloader = false;
