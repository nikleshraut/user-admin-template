            ...
            <div class="col-md-10 inner-body full-width no-padding">
                ...
                <div class="col-sm-12" v-for="lab in labs">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-default"><div class="btn-text">View</div></button>
                        </div>
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-default"><div class="btn-text">Edit</div></button>
                        </div>
                    </div>
  ...
  export default {
    mounted() {
      ...
      //this.$parent.page_title = "";
        ...
        this.$parent.page_title = "My Files";
        this.$parent.back_url = "#/";
        this.$parent.help_content = "<h4>My Files</h4> help content";
